...
Status: Foundation (Metadata System, Engineering Object Model)
...
Object relationships and the rest of the Repository Engine are not yet implemented.
...
- `include/oep/repository/uuid.hpp` — shared UUIDv4 generation/validation, used by both metadata and objects
...
- `src/metadata.cpp`, `src/engineering_object.cpp`, `src/object_store.cpp` — schema mapping, validation rules, atomic writes
